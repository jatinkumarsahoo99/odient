...
class AdHelper {
  static SharePre sharePre = SharePre();
  ...
  static getAds(BuildContext context) async {
    ...
    bannerad = await sharePre.read("banner_ad") ?? "";
    banneradIos = await sharePre.read("ios_banner_ad") ?? "";
    banneradid = await sharePre.read("banner_adid") ?? "";
    banneradidios = await sharePre.read("ios_banner_adid") ?? "";

    interstitalad = await sharePre.read("interstital_ad") ?? "";
    interstitalIos = await sharePre.read("ios_interstital_ad") ?? "";
    interstitaladid = await sharePre.read("interstital_adid") ?? "";
    interstitaladidios = await sharePre.read("ios_interstital_adid") ?? "";

    rewardad = await sharePre.read("reward_ad") ?? "";
    rewardadIos = await sharePre.read("ios_reward_ad") ?? "";
    rewardadid = await sharePre.read("reward_adid") ?? "";
    rewardadidios = await sharePre.read("ios_reward_adid") ?? "";
    String interstialAdClick = await sharePre.read("interstital_adclick") ?? "";
    String rewardAdClick = await sharePre.read("reward_adclick") ?? "";
    String interstialAdIOSClick =
        await sharePre.read("ios_interstital_adclick") ?? "";
    String rewardAdIOSClick = await sharePre.read("ios_reward_adclick") ?? "";
